...
const DateRangeFilter = ({ filterData, handleChange, months, hasOnlyNonWMMRoles, hasRole }) => {
  ...
  ), [filterData.calReceivedFromMonth, filterData.calReceivedFromDay, filterData.calReceivedFromYear,
      filterData.calReceivedToMonth, filterData.calReceivedToDay, filterData.calReceivedToYear,
      handleChange, monthOptions]);
  ...
  ), [filterData.calPaymentFromMonth, filterData.calPaymentFromDay, filterData.calPaymentFromYear,
      filterData.calPaymentToMonth, filterData.calPaymentToDay, filterData.calPaymentToYear,
      handleChange, monthOptions]);
  ...
  ), [filterData.hrgPaymentFromMonth, filterData.hrgPaymentFromDay, filterData.hrgPaymentFromYear,
      filterData.hrgPaymentToMonth, filterData.hrgPaymentToDay, filterData.hrgPaymentToYear,
      handleChange, monthOptions]);
  ...
  ), [filterData.hrgCampaignFromMonth, filterData.hrgCampaignFromDay, filterData.hrgCampaignFromYear,
      filterData.hrgCampaignToMonth, filterData.hrgCampaignToDay, filterData.hrgCampaignToYear,
      handleChange, monthOptions]);
  ...
  ), [filterData.fomPaymentFromMonth, filterData.fomPaymentFromDay, filterData.fomPaymentFromYear,
      filterData.fomPaymentToMonth, filterData.fomPaymentToDay, filterData.fomPaymentToYear,
      handleChange, monthOptions]);

  // Memoize the role selector section
  const roleSelectorSection = useMemo(() => {
    // Only show selector if user has multiple roles
    const hasMultipleRoles = ["HRG", "CAL", "FOM"].filter(role => hasRole(role)).length > 1;
      ...
      <div className="p-2 bg-white rounded-lg border border-gray-200">
        ...
        <div className="flex gap-2">
          {hasRole("HRG") && (
            <button
              type="button"
              onClick={() => handleChange({ target: { name: 'selectedDateFilterRole', value: 'HRG' }})}
          ...
          {hasRole("CAL") && (
            <button
              type="button"
              onClick={() => handleChange({ target: { name: 'selectedDateFilterRole', value: 'CAL' }})}
              className={`px-4 py-2 rounded-md ${
          ...
          {hasRole("FOM") && (
            <button
              type="button"
              onClick={() => handleChange({ target: { name: 'selectedDateFilterRole', value: 'FOM' }})}
              className={`px-4 py-2 rounded-md ${

...
export const fetchAccounting = async (
  ...
  try {
    ...
    const response = await axios.get(
      `http://${import.meta.env.VITE_IP_ADDRESS}:3001/accounting/payments?${params.toString()}`,
      {
        headers: {
    ...
    if (validPage !== page) {
      console.warn(`Requested page ${page} exceeds total pages ${totalPages}, adjusting to ${validPage}`);
    }

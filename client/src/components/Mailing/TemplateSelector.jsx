            ...
            {showDetails && (
              <>
                <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                  ...
                  {/* Integrated Technical Details */}
                  <div className="text-gray-600">Label Width:</div>
                  <div>{selectedTemplate.layout?.labelWidthIn || 3.5}"</div>

                  <div className="text-gray-600">Top Margin:</div>
                  ...
                  <div className="text-gray-600">Column 2 Position:</div>

...
const RenewalNoticeDataOverlay = forwardRef(
  (
    ...
    // Fetch templates for renewal notice (fetch ALL, filter by previewType client-side)
    useEffect(() => {
        ...
        <div className="flex-1 overflow-auto">
          ...
          <div className="flex flex-col md:flex-row w-full gap-4">
            ...
            <div className="w-full md:w-2/5 flex flex-col">
              ...
              {/* Moved Preview Print button to bottom footer */}
            </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  ...
                  already exists in {duplicateTemplate?.department} for Renewal.
                </p>

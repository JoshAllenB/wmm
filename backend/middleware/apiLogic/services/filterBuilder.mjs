...
async function addDateFilters(baseFilter, advancedFilterData) {
  // Use the top-level createDatePipeline for robust date normalization across all models
  ...
  if (advancedFilterData.startDate || advancedFilterData.endDate) {
    try {
      ...
      // Create pipelines for adddate only (editdate removed per requirements)
